...
//BusinessObjects.CITs.CITPosting
...
namespace CashSwiftCashControlPortal.Module.BusinessObjects.CITs
{
    ...
    public class CITPosting : XPLiteObject
    {
        private Guid fid;
        private string fcb_tx_number;
        private CITTransaction fcit_tx_id;
        ...
        private CITPostingStatus fpost_status;
        ...
        public CITTransaction cit_tx_id
        {
            get => fcit_tx_id;
            set => SetPropertyValue(nameof(cit_tx_id), ref fcit_tx_id, value);
        }
        ...
        [ModelDefault("AllowEdit", "False")]
        [DisplayName("Status")]
        public CITPostingStatus post_status
        {
            get => fpost_status;
        ...
        [Indexed(Name = "iinitialising_user_CITPosting")]
        ...
        [Indexed(Name = "iauthorising_user_CITPosting")]
        ...
        public CITPosting(Session session)
          : base(session)
        {
        }
