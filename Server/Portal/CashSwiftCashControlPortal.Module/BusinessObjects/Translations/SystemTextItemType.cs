...
//BusinessObjects.Translations.SystemTextItemType
...
namespace CashSwiftCashControlPortal.Module.BusinessObjects.Translations
{
    ...
    [FriendlyKeyProperty("token")]
    [DefaultProperty("name")]
    [Persistent("xlns.sysTextItemType")]
    public class SystemTextItemType : XPLiteObject
    {
        private Guid fid;
        ...
        public SystemTextItemType(Session session)
          : base(session)
        {
        }
