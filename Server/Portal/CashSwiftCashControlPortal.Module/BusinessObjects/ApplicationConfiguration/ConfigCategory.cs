...
//BusinessObjects.ApplicationConfiguration.ConfigCategory
...
namespace CashSwiftCashControlPortal.Module.BusinessObjects.ApplicationConfiguration
{
    ...
    public class ConfigCategory : XPLiteObject
    {
        private Guid fid;
        ...
        public XPCollection<Config> Configs => GetCollection<Config>(nameof(Configs));

        public ConfigCategory(Session session)
          : base(session)
        {
        }
