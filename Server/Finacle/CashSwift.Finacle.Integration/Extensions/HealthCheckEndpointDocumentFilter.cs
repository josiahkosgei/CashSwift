...
namespace CashSwift.Finacle.Integration.Extensions
{
    public class HealthCheckEndpointDocumentFilter : IDocumentFilter
    {
        ...
        /// 
        /// </summary>
        private readonly HealthChecks.UI.Configuration.Options _options;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="options"></param>
        public HealthCheckEndpointDocumentFilter(IOptions<HealthChecks.UI.Configuration.Options> options)
        {
