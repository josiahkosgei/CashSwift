// CashSwift.Integrations.CooperativeBank.SOAIntegrationClasses.FundsTransfers.v2_1.FundsTransferCreditPostingAccount
...
namespace CashSwift.Finacle.Integration.Models.SOAIntegrationClasses.FundsTransfers.v2_1
{
    ...
    public class FundsTransferCreditPostingAccount
    {
        private string standardAccountIdField;

        private FundsTransferCreditPostingAccountPseudonym pseudonymField;

        private string externalAccountIdField;

        private string iBANField;

        private FundsTransferCreditPostingAccountInputAccount inputAccountField;
        ...
        public FundsTransferCreditPostingAccountPseudonym pseudonym
        {
            get
            {
        ...
        public FundsTransferCreditPostingAccountInputAccount inputAccount
        {
            get
            {
