// CashSwift.Integrations.CooperativeBank.SOAIntegrationClasses.FundsTransfers.v2_1.FundsTransferTxnFXDataLocalRoundingDetailsLocalCashDetailsLclCashAcctDetails
...
namespace CashSwift.Finacle.Integration.Models.SOAIntegrationClasses.FundsTransfers.v2_1
{
    ...
    public class FundsTransferTxnFXDataLocalRoundingDetailsLocalCashDetailsLclCashAcctDetails
    {
        private string standardAccountIdField;

        private FundsTransferTxnFXDataLocalRoundingDetailsLocalCashDetailsLclCashAcctDetailsPseudonym pseudonymField;

        private string externalAccountIdField;

        private string iBANField;

        private FundsTransferTxnFXDataLocalRoundingDetailsLocalCashDetailsLclCashAcctDetailsInputAccount inputAccountField;
        ...
        public FundsTransferTxnFXDataLocalRoundingDetailsLocalCashDetailsLclCashAcctDetailsPseudonym pseudonym
        {
            get
            {
        ...
        public FundsTransferTxnFXDataLocalRoundingDetailsLocalCashDetailsLclCashAcctDetailsInputAccount inputAccount
        {
            get
            {
