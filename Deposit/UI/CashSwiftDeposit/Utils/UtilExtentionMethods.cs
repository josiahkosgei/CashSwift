...
namespace CashSwiftDeposit.Utils
{
    public class UtilExtentionMethods
    {
        ...
        public static class PasswordBoxHelper
        {
            ...
            {
                PasswordBox d = sender as PasswordBox;
                SetBoundPassword(d, d.Password);
                d.GetType().GetMethod("Select", BindingFlags.Instance | BindingFlags.NonPublic).Invoke(d, new object[2]
                {
           d.Password.Length,
           0
                });
