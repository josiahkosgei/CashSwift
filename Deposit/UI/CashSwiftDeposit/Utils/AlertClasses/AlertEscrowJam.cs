...
{
    public class AlertEscrowJam : AlertBase
    {
        ...
        protected new string GenerateHTMLMessageToken()
        {
            ...
            stringBuilder.Append(_transaction.ToEmailString());
            stringBuilder.AppendLine("<p><table style=\"text - align: left\">");
            stringBuilder.AppendLine("<tr><th>date_detected</th><th>dropped_amount</th><th>escrow_amount</th><th>posted_amount</th><th>retreived_amount</th><th>recovery_date</th><th>Initiating User</th><th>Authorising User</th></tr>");
            foreach (EscrowJam escrowJam in (IEnumerable<EscrowJam>)_transaction.Transaction.EscrowJams)
                escrowJam.ToEmailString();
        ...
        protected new string GenerateRawTextMessageToken()
        {
            ...
            sb.AppendLine(_transaction.ToRawTextString());
            _transaction.ToRawEscrowJamString(sb);
            return sb.ToString();
        }
