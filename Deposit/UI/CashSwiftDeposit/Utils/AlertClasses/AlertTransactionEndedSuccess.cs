...
{
    public class AlertTransactionEndedSuccess : AlertBase
    {
        public const int ALERT_ID = 4006;
        private AppTransaction _transaction;

        public AlertTransactionEndedSuccess(
          ...
          : base(device, dateDetected)
        {
            ...
            using (DepositorDBContext depositorDbContext = new DepositorDBContext())
                AlertType = depositorDbContext.AlertMessageTypes.FirstOrDefault(x => x.id == 4006);
        }
