// ViewModels.UserMessageScreenViewModel
...
namespace CashSwiftDeposit.ViewModels
{
    ...
    public class UserMessageScreenViewModel : DepositorCustomerScreenBaseViewModel
    {
          ...
          : base(title, applicationViewModel, required)
        {
            ...
            NextCaption = ApplicationViewModel.CashSwiftTranslationService?.TranslateSystemText("NextCaption", "sys_Dialog_OK_Caption", "OK");
            ScreenTitle = title;
        }
        ...
        private void StatusWorker_DoWork(object sender, DoWorkEventArgs e) => ApplicationViewModel.NavigateNextScreen();
    }
}
