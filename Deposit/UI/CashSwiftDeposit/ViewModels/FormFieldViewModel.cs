...
{
    public class FormFieldViewModel : Screen
    {
        ...
        public FormFieldViewModel(IDepositorForm form, FormListItem field)
        {
            ...
            NextButton_Caption = ApplicationViewModel.CashSwiftTranslationService.TranslateSystemText("FormFieldViewModel.Constructor", "sys_NextButton_Caption", "Next");
            BackButton_Caption = ApplicationViewModel.CashSwiftTranslationService.TranslateSystemText("FormFieldViewModel.Constructor", "sys_BackButton_Caption", "Back");
        }

        public void Validate() => Validate(DataEntryTextbox);
        ...
        public void Back() => Form.FormHome(false);
    }
}
