...
namespace CashSwiftDeposit.ViewModels.RearScreen
{
    public class RearScreenMainViewModel : Screen
    {
          ...
          ApplicationViewModel applicationViewModel)
        {
            ...
            AdminButtonCaption = ApplicationViewModel.CashSwiftTranslationService.TranslateSystemText("RearScreenMainViewModel._ctor", "sys_RearScren_AdminButtonCaption", "Admin Login");
        ...
        public string AdminButtonCaption
        {
            ...
            set
            {
                ...
                NotifyOfPropertyChange(() => AdminButtonCaption);
            }
        }
        ...
        public void AdminButton()
        {
            ...
            MenuBackendATMViewModel backendAtmViewModel = new MenuBackendATMViewModel("Main Menu", ApplicationViewModel, Conductor, this);
        }
    }
}
