...
namespace CashSwiftDeposit.ViewModels.DummyData
{
    public class DummyAppTransactionDenominations
    {
        public int TotalAmountCents { get; internal set; } = 37000000;

        public Denomination TotalDenominationResult { get; internal set; } = new Denomination()
        {
            denominationItems = new List<DenominationItem>()
      {
        ...
        public Denomination CountedDenominationResult { get; internal set; } = new Denomination()
        {
            denominationItems = new List<DenominationItem>()
      {
        new DenominationItem()
        ...
        public Denomination DroppedDenomination { get; internal set; } = new Denomination()
        {
            denominationItems = new List<DenominationItem>()
      {
        new DenominationItem()
