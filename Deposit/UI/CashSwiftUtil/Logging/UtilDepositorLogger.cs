...
// Type: CashSwiftUtil.Logging.UtilDepositorLogger
...
namespace CashSwiftUtil.Logging
{
    ...
    {
        private ICashSwiftLogger _innerLogger;

        public bool IsTraceEnabled
        {
            get
            {
                ICashSwiftLogger innerLogger = _innerLogger;
        ...
        public void LogFormat(
          ...
          params object[] EventDetailFormatObjects)
        {
            LogToFileFormat(Component, EventName, EventType, Level, EventDetailFormat, EventDetailFormatObjects);
        }
