...
{
    public class UtilNLogLogger : ICashSwiftLogger
    {
       ...
       exception.InnerException?.InnerException?.InnerException?.Message
        ...
        public void ErrorFormat(UtilLogEntry logEntry) => _innerLogger.Error("\u0002{5}|{0:yyyy-MM-dd HH:mm:ss.ffff zzzz}|{1}|{3}|{4}|{2}\u0003", new object[6]
        {
       logEntry.date,
       logEntry.eventName,
       ...
       logEntry.level.ToString().PadRight(5)
        ...
        public void InfoFormat(UtilLogEntry logEntry) => _innerLogger.Info("\u0002{5}|{0:yyyy-MM-dd HH:mm:ss.ffff zzzz}|{1}|{3}|{4}|{2}\u0003", new object[6]
        {
       logEntry.date,
       logEntry.eventName,
       logEntry.eventDetail,
       ...
       logEntry.level.ToString().PadRight(5)
        ...
        public void WarnFormat(UtilLogEntry logEntry) => _innerLogger.Warn("\u0002{5}|{0:yyyy-MM-dd HH:mm:ss.ffff zzzz}|{1}|{3}|{4}|{2}\u0003", new object[6]
        {
       logEntry.date,
       logEntry.eventName,
       logEntry.eventDetail,
       ...
       logEntry.level.ToString().PadRight(5)
        ...
        public void FatalFormat(UtilLogEntry logEntry) => _innerLogger.Fatal("\u0002{5}|{0:yyyy-MM-dd HH:mm:ss.ffff zzzz}|{1}|{3}|{4}|{2}\u0003", new object[6]
        {
       logEntry.date,
       logEntry.eventName,
       logEntry.eventDetail,
       ...
       logEntry.level.ToString().PadRight(5)
        ...
        public void DebugFormat(UtilLogEntry logEntry) => _innerLogger.Debug("\u0002{5}|{0:yyyy-MM-dd HH:mm:ss.ffff zzzz}|{1}|{3}|{4}|{2}\u0003", new object[6]
        {
       logEntry.date,
       logEntry.eventName,
       logEntry.eventDetail,
       ...
       logEntry.level.ToString().PadRight(5)
        ...
        public void TraceFormat(UtilLogEntry logEntry) => _innerLogger.Trace("\u0002{5}|{0:yyyy-MM-dd HH:mm:ss.ffff zzzz}|{1}|{3}|{4}|{2}\u0003", new object[6]
        {
       logEntry.date,
       logEntry.eventName,
       logEntry.eventDetail,
