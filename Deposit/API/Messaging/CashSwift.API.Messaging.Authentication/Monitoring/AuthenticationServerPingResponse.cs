...
// Type: CashSwift.API.Messaging.Authentication.Monitoring.AuthenticationServerPingResponse
...
{
    public class AuthenticationServerPingResponse : ServerPingResponseBase
    {
    }
}
