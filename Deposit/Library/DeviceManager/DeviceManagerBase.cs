...
namespace DeviceManager
{
    public abstract class DeviceManagerBase : IDeviceManager, INotifyPropertyChanged
    {
        ...
        private DeviceManagerMode deviceManagerMode = DeviceManagerMode.NONE;
        private bool _isEnabled = true;
        private DeviceManagerState _currentState = DeviceManagerState.INIT;
        private IControllerStatus _currentDeviceStatus = new ControllerStatus();

        protected CashSwiftLogger Log { get; set; } = new CashSwiftLogger(Assembly.GetExecutingAssembly().GetName().Version.ToString(), nameof(DeviceManagerBase), null);
        ...
        public virtual IControllerStatus CurrentDeviceStatus
        {
