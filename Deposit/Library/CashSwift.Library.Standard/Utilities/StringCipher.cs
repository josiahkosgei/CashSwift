...
namespace CashSwift.Library.Standard.Utilities
{
    public static class StringCipher
    {
        ...
        public static string Decrypt(this string cipherText, byte[] passPhrase)
        {
            ...
            byte[] array1 = source.Take(16).ToArray();
            byte[] array2 = source.Skip(16).Take(16).ToArray();
            byte[] array3 = source.Skip(32).Take(source.Length - 32).ToArray();
